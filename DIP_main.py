...
import draw
#shape dictionary
print (shape_detection.shape_detection("test_images/hand_writ.jpeg"))
shapes_dictionary, relations = shape_detection.shape_detection("test_images/hand_writ.jpeg")
